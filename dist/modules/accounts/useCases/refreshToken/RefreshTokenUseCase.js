...
let RefreshTokenUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  constructor(userTokenRepository, dayjsDateProvider) {
  ...
  async execute(token) {
    ...
    const refresh_token = (0, _jsonwebtoken.sign)({
      ...
      subject: sub,
      expiresIn: _auth.default.expires_in_refreshToken
    });
    const refresh_token_expire_date = this.dayjsDateProvider.addDays(_auth.default.expires_refresh_token_day);
